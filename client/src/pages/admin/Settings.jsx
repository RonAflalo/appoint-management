  ...
  return (
    <div>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        {/* Terms */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-1">תנאי שימוש</h2>
          <p className="text-sm text-gray-400 mb-4">אם מופעל, הלקוח יידרש לאשר את התנאים לפני קביעת תור</p>
          <label className="flex items-center gap-3 cursor-pointer mb-4">
            ...
            <span className="text-sm font-medium text-gray-700">הצג תנאי שימוש בדף ההזמנה</span>
          </label>
          {termsEnabled && (
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">טקסט תנאי השימוש</label>
              <textarea
                value={termsText}
